...
parser.add_argument('--gpu', type=int, help='specify the gpu number to use', default=None)
...
parser.add_argument('--get_dist_dict', action='store_true')
...
parser.add_argument('--eval_mode', default='mult', choices=['mult', 'add', 'lld', 'prior'])
